...
export const authLimiter = rateLimit({
    ...
    message: {
        ...
        suggestedActions: 'Wait 15 minutes before attempting new authentication requests.',
        title: 'Too Many Authentication Attempts.',
        detail: 'You have exceeded the authentication request limit. Please try again later.'
    } satisfies IJsonApiResponseError
})
